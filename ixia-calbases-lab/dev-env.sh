...
elif [ "$1" = "t2_bgp" ] || [ "$1" = "t2_bgp" ]; then
    echo "t2_bgp"
    cp -f  $SCRIPT_DIR/t2_bgp/ansible/testbed.csv  /var/AzDevOps/sonic-mgmt/ansible/testbed.csv
    cp -f  $SCRIPT_DIR/t2_bgp/ansible/files/sonic_snappi-sonic_links.csv  /var/AzDevOps/sonic-mgmt/ansible/files/sonic_snappi-sonic_links.csv
    cp -f  $SCRIPT_DIR/t2_bgp/ansible/files/sonic_snappi-sonic_devices.csv  /var/AzDevOps/sonic-mgmt/ansible/files/sonic_snappi-sonic_devices.csv
    cp -rf  $SCRIPT_DIR/t2_bgp/ansible/group_vars/snappi-sonic/  /var/AzDevOps/sonic-mgmt/ansible/group_vars/snappi-sonic/
    cp -f  $SCRIPT_DIR/t2_bgp/ansible/snappi-sonic  /var/AzDevOps/sonic-mgmt/ansible/snappi-sonic
    cp -f  $SCRIPT_DIR/t2_bgp/vms-snappi-sonic.json /var/AzDevOps/sonic-mgmt/tests/metadata/vms-snappi-sonic.json
else
